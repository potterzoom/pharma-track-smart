...
import { Package, Download, Eye, Calendar, Filter, Search, FileText, BarChart3 } from 'lucide-react';
  ...
  return <div className="space-y-6">
      ...
      <Card className="p-6 bg-neutral-50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          return <Card key={index} className="p-4 hover:shadow-md transition-shadow cursor-pointer bg-zinc-300">
      ...
      <Card className="p-4 bg-neutral-50">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <select value={selectedPeriod} onChange={e => setSelectedPeriod(e.target.value)} className="border border-gray-300 rounded-md px-3 py-1 text-sm">
      ...
      <Card className="p-6 bg-neutral-50">
        ...
        <Table>
          ...
          <TableBody>
            {inventoryReports.map(report => <TableRow key={report.id}>
                <TableCell>
                  <div>
                ...
                <TableCell>
                  <Badge variant="outline" className="capitalize">
                    {report.period === 'daily' ? 'Diario' : report.period === 'weekly' ? 'Semanal' : report.period === 'monthly' ? 'Mensual' : 'Anual'}
                  </Badge>
                </TableCell>
                <TableCell>
                ...
                <TableCell>
                  <div className="flex items-center space-x-2">
                    ...
                    {report.status === 'completed' && <Button variant="ghost" size="sm">
