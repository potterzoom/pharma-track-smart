...
const StockAlertReports = () => {
  const currentAlerts = [
    { product: 'Paracetamol 500mg', branch: 'Centro', stock: 5, minStock: 20, severity: 'critical' },
    { product: 'Ibuprofeno 400mg', branch: 'Norte', stock: 12, minStock: 15, severity: 'warning' },
    { product: 'Amoxicilina 250mg', branch: 'Sur', stock: 18, minStock: 25, severity: 'warning' }
  ];
