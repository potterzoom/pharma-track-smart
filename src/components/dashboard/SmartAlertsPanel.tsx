      ...
      <CardContent>
        <div className="space-y-3">
          ...
          <div className="flex gap-2 mb-4">
            <Button
              variant={activeFilters.severity === 'all' ? 'default' : 'outline'}
              size="sm"
              onClick={() => setActiveFilters({ ...activeFilters, severity: 'all' })}
            >
              Todas
            </Button>
            <Button
              variant={activeFilters.severity === 'critical' ? 'destructive' : 'outline'}
              size="sm"
              onClick={() => setActiveFilters({ ...activeFilters, severity: 'critical' })}
            >
              Críticas
            </Button>
            <Button
              variant={activeFilters.severity === 'high' ? 'destructive' : 'outline'}
              size="sm"
              onClick={() => setActiveFilters({ ...activeFilters, severity: 'high' })}
            >
              Altas
            </Button>
          </div>
